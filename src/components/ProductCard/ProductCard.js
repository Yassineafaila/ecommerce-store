...
function Card({ product,liked }) {
  const navigate = useNavigate();
  const { AddProductsToCart, AddLikedProducts, RemoveLikedProduct } =
    useProducts();
  const {
    category,
    description,
  ...
  return (
    ...
    >
      <div className="card__img">
        ...
        {liked ? (
          <button className="button__remove" onClick={() => RemoveLikedProduct(product.id)}>
          ...
          <>
            ...
            <button
              className="card__button card__more"
